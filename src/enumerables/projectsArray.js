export const projects = [
    {   
        ...
        techUsed: "React, Clientside Routing, JWT Token Auth., Redux, Thunk, CSS Grid, and the Semantic UI React Library, Ruby on Rails w/ PostgressSQL for persistance"
    },

    {   
        id: "p2",
        title: "MeetByMe",
        description: "A way to look at MeetUps happening near your current location. It allows you to save the MeetUp and displays it's location relative to yours using MapBoxGL.",
        githubLink: "https://github.com/wley3337/MeetByMe",
        techUsed: "React, Clientside Routing, JWT Token Auth., Ruby on Rails w/ PostgressSQL for persistance, External APIs: MapboxGL and MeetUp"
    },
    {   
        id: "p3",
        title: "Onitama",
        description: "A clone of the board game Onitama. It's a combination between chess and checkers where players compeate using 5 of the 16 different movement cards chosen randomly at the start of the game.",
        githubLink: "https://github.com/wley3337/onitama-frontend",
        techUsed: "JavaScript, AJAX, HTML 5, CSS Grid, Ruby on Rails w/ PostgressSQL for persistance"
    },
    {   
        id: "p4",
        ...
        techUsed: "Ruby on Rails w/ PostgressSQL for persistance"
    }
...
export const inProgressProjects = [
    {
        ...
        techUsed: "React, Clientside Routing, Redux, Thunk, CSS Grid, and the Semantic UI React Library, and multiple external API's (see README)"
    }
]